...
//
// Example usage:
//   runWithinPluginEditor ([&] (DemoPluginAudioProcessor& plugin) {
//       auto* editor = plugin.getActiveEditor();
//       REQUIRE (editor != nullptr);
//   });
[[maybe_unused]] static void runWithinPluginEditor (const std::function<void (DemoPluginAudioProcessor& plugin)>& testCode)
{
