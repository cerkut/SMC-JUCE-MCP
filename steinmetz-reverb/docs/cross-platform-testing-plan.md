...
| G.4 | Ubuntu VM: Run Catch2 tests. | [~] | FIXED in 837643c: Test files now use SteinmetzReverb pattern. Tests compile on macOS CI. Needs re-verification on Ubuntu VM. |
